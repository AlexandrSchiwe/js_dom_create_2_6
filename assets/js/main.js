...
button.textContent = "Generate random image";
button.setAttribute("onclick", "generateImg()");
...
let generateImg = () => {
    ...
    document.getElementById('content').src = data[randomNum];
    console.log(data[randomNum].download_url);
    content.innerHTML = document.body.appendChild(img);
}